            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Mis Clientes <small>Gestión de auditorías digitales</small></h3>
                    </div>
                    <a href="<?php echo base_url(); ?>index.php/company/create/<?php echo $agent['id']; ?>" class="btn btn-success">Nuevo Cliente</a>
                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table">
                                        ...
                                        <tr class="headings">
                                            ...
                                            <th class="column-title">Persona de contacto </th>
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "><?php echo $company['name_request']; ?></td>
                                            <td class=" "><?php echo $company['email']; ?></td>
                                            <td class=" last"><a href="<?php echo base_url(); ?>index.php/company/listAudit/<?php echo $company['id']; ?>">Ver Auditorías</a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
